...
import { calculateSavingsGoal } from '../utils/calculators';
import { SavingsGoalInputs, SavingsGoalResults } from '../types/calculator';
...
export const SavingsGoalCalculator: React.FC = () => {
  ...
  const [results, setResults] = useState<SavingsGoalResults>({
    monthlyRequired: 0,
  ...
  const handleCalculate = useCallback(() => {
    setResults(calculateSavingsGoal(inputs));
  }, [inputs]);
